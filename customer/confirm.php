...
<?php
	if (isset($_POST['confirm'])) {
		...
		$update_pendingorder = "UPDATE pendind_orders SET order_status='$complete' WHERE order_id='$update_id'";

		$run_pendingupdate = mysqli_query($con,$update_pendingorder);

		if ($run_payment) {
			
			echo "<h2 style='text-align:center; color:white;'>Payment received, your order completed within 24 hours</h2>";
		}
	}
