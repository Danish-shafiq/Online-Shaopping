<?php
	...
	//This Function is used for getting the ip address
	...
	function getRealIpAddr(){
		...
		if (!empty($_SERVER['HTTP_CLIENT_IP'])) 
			//CHEAK IP FORM share internet
		{
			$ip = $_SERVER['HTTP_CLIENT_IP'];	
		}

		elseif (!empty($_SERVER['HTTP_X_FORWARDED_FOR'])) 
			//to cheak ip is pass from proxy
		{
	...
	//This function is used for get products on database and display in site.
	function getpro()
	{					
						global $con;
	...
	//This function is used when you click on some any catagory.
	...
	{					
						...
						if ($count==0) 
						{
							echo "<b><h2>No Product Found in this category!</h2></b>";
						}
	...
	//This function is used when you click on some any brand.
	...
	{					
						...
						if ($count==0) 
						{
							echo "<b><h2>No Product Found in this Brand!</h2></b>";
						}
	...
	//This function is used for get category from database and display in site.

	function gercategory()
	{
					global $con;
	...
	//This function is useed for get brands from database and display in site.
	...
	//This function is creating for add product in add to cart
	...
	//This function is used for count total products.
	...
	//This function is used for gething the total price of the items from the cart
