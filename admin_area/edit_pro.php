<?php
	...
	if (isset($_GET['edit_pro'])) {
		...
		$p_tittle = $row_edit['product_title'];
	...
	<form method="post" action="" enctype="multipart/form-data">
		...
		<table width="794" align="center" border="1" bgcolor="#3399cc">
			...
			<tr>
				...
				<td><input type="text" name="product_title" size="50" value="<?php echo $p_tittle; ?>"></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input type="file" name="product_img2"><br><img src="product_images/<?php echo $p_image2; ?>" width="80" height="80"><br></td>
			</tr>
			<tr>
				<td align="right"><b>Product Image 3 :</b></td>
				<td><input type="file" name="product_img3"><br><img src="product_images/<?php echo $p_image3; ?>" width="80" height="80"><br></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><textarea name="product_desc" cols="50" rows="10"><?php echo $p_desc; ?></textarea></td>
			</tr>
			<tr>
				<td align="right"><b>Product Keywords :</b></td>
				<td><input type="text" name="product_keywords" size="50" value="<?php echo $p_keyword; ?>"></td>
			</tr>
			<tr align="center">
